 ...
 * 
 * A "cons" is simply a pair (L,R) holding a specific value
 * on the left hand side (L) and the right hand side (R).
 * 
 * @author leberre
 *
 * @param <L> the
...
public class Cons<L, R> {
	...
	/**
	 * Private default constructor to prevent its use
	 * outside the class.
	 */
	private Cons() {
		this.car = null;
	 ...
	 * 
	 * @param car the left hand side.
	 * @param cdr the right hand side.
	 */
